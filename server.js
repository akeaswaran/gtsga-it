...
app.post('/emailAssignees', function(request, response) {
  ...
  if (card.notificationsEnabled) {
    ...
    console.log('Notifications are not enabled for card ' + card._id);
  }
});
